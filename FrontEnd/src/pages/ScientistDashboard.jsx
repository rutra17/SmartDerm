...
function ScientistPanel() {
    ...
    // Tabela de Preços Estimados (em Dólares $) por requisição/imagem
    const PRECOS_API = {
        'gemini': 0.00012,
        'openai': 0.00250,
        'deepseek': 0.00010,
                ...
                <div className="flex-1 p-4 space-y-2">
                    <button 
                        ...
                        className={`w-full text-left p-3 rounded-lg border transition font-semibold ${
                            abaAtiva === 'dashboard' ? 'bg-purple-600/20 border-purple-500 text-purple-400' : 'border-transparent text-gray-400 hover:bg-gray-700/50'
                        }`}
                    >
                        📊 Dashboard Geral
                    </button>
                    <button 
                        onClick={() => setAbaAtiva('prompts')}
                        className={`w-full text-left p-3 rounded-lg border transition font-semibold ${
                            abaAtiva === 'prompts' ? 'bg-purple-600/20 border-purple-500 text-purple-400' : 'border-transparent text-gray-400 hover:bg-gray-700/50'
                        }`}
                    >
                        ⚙️ Engenharia Prompts
                    </button>
                    <button 
                        onClick={() => setAbaAtiva('custos')}
                        className={`w-full text-left p-3 rounded-lg border transition font-semibold ${
                            abaAtiva === 'custos' ? 'bg-purple-600/20 border-purple-500 text-purple-400' : 'border-transparent text-gray-400 hover:bg-gray-700/50'
                        }`}
                    >
                        📈 Custos e API
                    </button>
                                                        ...
                                                        return (
                                                            <div key={modelo}>
                                                                <div className="flex justify-between text-sm mb-2">
                                                                    ...
                                                                    <span className="text-gray-400 font-mono">{quantidade} testes ({percentagem}%)</span>
                                                                </div>
                                                                <div className="w-full bg-gray-700 rounded-full h-4 overflow-hidden">
                                                                    <div className="bg-purple-500 h-4 rounded-full transition-all duration-1000 relative" style={{ width: `${percentagem}%` }}>
                                ...
                                <div className="space-y-8 animate-fade-in">
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                        <div className="bg-[#202123] p-6 rounded-xl border border-yellow-500/40 shadow-lg">
                                            ...
                                            <p className="text-xs text-gray-500 mt-2">Dólares americanos com base nas tabelas das APIs.</p>
                                        </div>
                                        <div className="bg-[#202123] p-6 rounded-xl border border-gray-700 shadow-lg">
                                            ...
                                            <p className="text-xs text-gray-500 mt-2">Media calculada em {estatisticas.totalConsultas} consultas.</p>
                                        </div>
                                        <div className="bg-[#202123] p-6 rounded-xl border border-gray-700 shadow-lg">
                                        ...
                                        <table className="w-full text-left text-sm">
                                            ...
                                            <tbody className="divide-y divide-gray-700">
                                                {listaCustosModelos.length === 0 ? (
                                                    <tr><td colSpan="4" className="px-6 py-8 text-center text-gray-500">Sem dados financeiros para apresentar.</td></tr>
                                                ) : (
                                                    listaCustosModelos.map((item) => (
                                                        <tr key={item.modelo} className="hover:bg-gray-800/50 transition">
                                                            ...
                                                            <td className="px-6 py-4 text-right text-gray-300 font-mono">{item.quantidade}</td>
