        ...
        <main className="min-h-screen bg-smart-blue text-white flex flex-col" aria-labelledby="home-title">
            ...
            <header className="py-8 px-4 border-b border-gray-700">
                <div className="max-w-6xl mx-auto flex items-center justify-between">
                    <img src="src\assets\img\logo.png" alt="Logo da SmartDerm" className="h-12" />
                ...
                <div className="max-w-5xl mx-auto px-4 py-16 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                    <div>
                        ...
                        <div className="flex gap-4">
                            <Link to="/login" className="bg-emerald-500 text-white font-semibold px-5 py-3 rounded focus:outline-none focus:ring-2 focus:ring-smart-teal transition duration-300 ease-in-out hover:bg-emerald-600">Entrar</Link>
                        ...
                        <ul className="mt-8 space-y-3 text-gray-300">
                            <li><strong>Contraste otimizado:</strong> cores selecionadas para atender WCAG AA/AAA quando possível.</li>
                            <li><strong>Navegação por teclado:</strong> todas as ações podem ser feitas via Tab/Enter.</li>
                            <li><strong>Compatível com leitores de tela:</strong> marcação semântica e labels claras.</li>
                        </ul>
                    </div>
            ...
            <footer className="py-6 border-t border-gray-800">
                <div className="max-w-6xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-4">
                    ...
                    <nav aria-label="Rodapé">
                        <ul className="flex gap-4">
                            <li><a href="#" className="text-smart-mint hover:underline">Acessibilidade</a></li>
                            <li><a href="#" className="text-smart-mint hover:underline">Privacidade</a></li>
                        </ul>
                    </nav>
                </div>
            </footer>
